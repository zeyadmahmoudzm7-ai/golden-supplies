...
const translations = {
    en: {
        ...
        'hero.title': 'Golden Supplies Trading',
        'hero.subtitle': 'Premium Tools & Products for Professionals',
        ...
        'home.title': 'Golden Supplies Trading',
        'home.slogan': 'Your Trusted Partner for Premium Tools & Products',
        'home.description': 'Since 2007, we have been providing industries across Saudi Arabia with the finest cutting tools, abrasives, and woodworking products from leading international brands. Our commitment to quality and exceptional service has made us the preferred choice for contractors and manufacturing industries.',
        ...
        'products.subtitle': 'Professional tools and products for every need',
        'products.cuttingTools': 'Cutting Tools',
        'products.cuttingToolsDesc': 'Precision cutting tools for woodworking, construction, aluminum, and artificial marble',
        'products.routerBits': 'Boring Bits',
        'products.sawBlades': 'Saw Blades',
        'products.cncTools': 'CNC Cutting Tools',
        'products.diamondTools': 'Diamond Cutting Tools',
        'products.abrasives': 'Abrasives',
        'products.abrasivesDesc': 'High-quality sanding and polishing materials for surface preparation, finishing, and automotive sanding',
        'products.abrasiveDiscs': 'Sanding Discs',
        'products.abrasiveRolls': 'Sanding Belts',
        'products.woodAdhesive': 'Wood Adhesive',
        'products.woodAdhesiveDesc': 'High-quality wood adhesives and bonding solutions. We provide liquid glue, powder glue, hot melt, and many more.',
        ...
        'brands.subtitle': 'Trusted by manufacturing industries worldwide',
        ...
        'brands.korea': 'Korea',
        'brands.germany_austria': 'Germany / Austria',
        'brands.countries.germany': 'Germany',
        'brands.countries.italy': 'Italy',
        'brands.countries.usa': 'USA',
        'brands.countries.china': 'China',
        'brands.countries.turkey': 'Turkey',
        'brands.countries.korea': 'Korea',
        'brands.countries.germany_austria': 'Germany / Austria',
        'contact.title': 'Contact Us',
        'contact.subtitle': 'Get in touch with our team',
        'contact.getInTouch': 'Get in Touch',
        'contact.description': 'Ready to get started? Contact us today for all your tool and product needs.',
        'contact.phone': 'Phone',
        'contact.email': 'Email',
        ...
        'contact.phoneEasternJeddah': '+966 56 652 1651',
        ...
        // Footer translations
        'footer.description': 'Your trusted partner for premium tools and products since 2007. We provide high-quality products from leading international brands to industries across Saudi Arabia.',
        ...
        'stats.yearsDesc': 'Serving manufacturing industries across Saudi Arabia since 2007',
        'stats.brands': 'Premium Brands',
        'stats.brandsDesc': 'Official representative for leading international manufacturers',
        'stats.products': 'Quality Products',
        'stats.productsDesc': 'Wide range of tools and products for every need',
        'stats.clients': 'Satisfied Clients',
        'stats.clientsDesc': 'Trusted by contractors and manufacturing industries nationwide'
    },
    ar: {
        ...
        'hero.title': 'مؤسسة التوريدات الذهبية',
        'hero.subtitle': 'أدوات ومنتجات عالية الجودة',
        ...
        'branches.jeddah': 'جدة',
        'home.title': 'مؤسسة التوريدات الذهبية',
        'home.slogan': 'شريكك الموثوق للأدوات والمنتجات عالية الجودة',
        'home.description': 'منذ عام ٢٠٠٧، نوفّر للشركات المصنعة في جميع أنحاء المملكة العربية السعودية أفضل أدوات القطع ومواد الصنفرة ومعدات النجارة من العلامات التجارية الدولية الرائدة. التزامنا بالجودة والخدمة الاستثنائية يجعلنا الخيار المفضل للمقاولين والمصانع.',
        'home.quality': 'جودة عالية',
        'home.qualityDesc': 'منتجات مختارة من علامات دولية رائدة',
        'home.experience': 'خدمة احترافية',
        'home.experienceDesc': 'إرشاد ودعم مهني لجميع احتياجاتك',
        'home.reliability': 'شريك موثوق',
        'home.reliabilityDesc': 'سلسلة توريد موثوقة وخدمة عملاء منذ عام ٢٠٠٧',
        'products.title': 'منتجات مميزة',
        'products.subtitle': 'أدوات ومنتجات لكل احتياج',
        'products.cuttingTools': 'أدوات القطع',
        'products.cuttingToolsDesc': 'أدوات قطع دقيقة للنجارة والبناء والألمنيوم والرخام الصناعي.',
        'products.cuttingToolsDescOld': 'بتات الراوتر، شفرات المنشار الدائري، ومعدات القطع الدقيقة',
        'products.routerBits': 'ريش تخريم',
        'products.sawBlades': 'صينية منشار',
        'products.cncTools': 'أدوات قطع CNC',
        'products.diamondTools': 'أدوات قطع الماس',
        'products.abrasives': 'الصنفرة',
        'products.abrasivesDesc': 'مواد صنفرة وتلميع عالية الجودة لإعداد الأسطح والتشطيب وصنفرة السيارات.',
        ...
        'products.woodAdhesiveDesc': 'حلول ربط مهنية لمشاريع النجارة والبناء. نوفر غراء خشب سائل، غراء بودرة، غراء حبيبات، ولاصقات عالية الجودة لصناعة الأثاث والنجارة والتطبيقات الإنشائية.',
        ...
        'products.handToolsDesc': 'أدوات يدوية وملحقات أساسية للنجارة والبناء. نوفر ماكينة صنفرة ترددية بالهواء، قاعدة ماكينة صنفرة، وأدوات متخصصة للعمل الدقيق والتشطيب.',
        ...
        'brands.subtitle': 'موثوق به من قبل المصانع حول العالم',
        ...
        'brands.turkey': 'تركيا',
        'brands.korea': 'كوريا',
        'brands.germany_austria': 'ألمانيا / النمسا',
        'brands.countries.germany': 'ألمانيا',
        'brands.countries.italy': 'إيطاليا',
        'brands.countries.usa': 'الولايات المتحدة',
        'brands.countries.china': 'الصين',
        'brands.countries.turkey': 'تركيا',
        'brands.countries.korea': 'كوريا',
        'brands.countries.germany_austria': 'ألمانيا / النمسا',
        'brands.keyProducts': 'المنتجات الرئيسية',
        'contact.title': 'تواصل معنا',
        'contact.subtitle': 'تواصل مع فريقنا',
        'contact.getInTouch': 'تواصل معنا',
        'contact.description': 'جاهزون لخدمتك. تواصل معنا اليوم لجميع احتياجاتك من الأدوات والمعدات.',
        'contact.phone': 'الهاتف',
        'contact.email': 'البريد الإلكتروني',
        'contact.calling': 'الاتصال',
        'contact.callingDesc': 'تواصل معنا مباشرة',
        'contact.branches': 'الفروع',
        'contact.branchesDesc': 'زورونا في مواقعنا',
        ...
        'contact.jeddah': 'جدة',
        'contact.dammamAddress': 'مبنى المهنا التجاري، شارع الملك عبدالعزيز، المحمدية، الدمام ٣٢٤٣٢',
        'contact.jeddahAddress': 'قرينيا، جدة',
        'contact.riyadhAddress': 'طريق المدينة المنورة، الصناعية، الرياض ١٢٨٤٣',
        'contact.phoneEasternJeddah': '+966 56 652 1651',
        'contact.phoneRiyadh': '+966 56 308 7176',
        'contact.emailGeneral': 'sales@golden-supplies.com',
        'contact.emailRiyadh': 'salesriyadh@golden-supplies.com',
        ...
        'stats.years': 'سنة من التميز',
        'stats.yearsDesc': 'نخدم المصانع في جميع أنحاء المملكة العربية السعودية منذ عام ٢٠٠٧',
        'stats.brands': 'علامات تجارية متميزة',
        'stats.brandsDesc': 'وكيل معتمد لأبرز الشركات المصنِّعة الدولية',
        'stats.products': 'منتجات عالية الجودة',
        'stats.productsDesc': 'مجموعة واسعة من الأدوات والمنتجات لكل احتياج',
        'stats.clients': 'عملاء راضون',
        'stats.clientsDesc': 'موثوق به من قبل المقاولين والمصانع على مستوى المملكة',
        
        // Footer translations
        'footer.description': 'شريكك الموثوق للأدوات والمنتجات المتميزة منذ عام ٢٠٠٧. نوفر منتجات عالية الجودة من علامات دولية رائدة لعملائنا في مختلف أنحاء المملكة.',
...
function redirectToMobileIfNeeded() {
    // Deprecated: previously redirected to index-mobile.html. No-op now.
    return;
}
...
function initializeVideoCarousel() {
    ...
    // Ensure natural playback and handle short videos
    videoSlides.forEach((video) => {
        video.loop = false;
        // If the video is shorter than 10s, switch immediately when it ends
        video.addEventListener('ended', function onEnd() {
            const duration = video.duration;
            if (!isFinite(duration) || isNaN(duration) || duration < 10) {
...
function switchToVideo(index) {
    ...
    // Play the new video from the start without segment seeking
...
// Update language switcher for all devices
function updateLanguageSwitcher() {
    const langButton = document.querySelector('.lang-switch-btn span');
    if (!langButton) return;
    
    const currentLang = (typeof currentLanguage !== 'undefined' && currentLanguage) || document.documentElement.lang || 'en';
    
    // Always show "English" when in Arabic, "العربية" when in English
    if (currentLang === 'ar') {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // redirectToMobileIfNeeded(); // disabled
    ...
    // (Removed forced line break for Quality Products on initial load)
    ...
    // Make switchToVideo globally accessible
    window.switchToVideo = switchToVideo;
    
    
    // (moved earlier to ensure stats animate from 0 to correct target)
    ...
    window.addEventListener('resize', updateLanguageSwitcher);
...
function updateLanguage(language) {
    ...
    setTimeout(() => {
        initializeAutoCarousels();
        // Reinitialize stats animation after language change
        initializeStatsAnimation();
        // (Removed forced line break for Quality Products on language change)
    }, 100);
}
...
function initializeStatsAnimation() {
    ...
    // Create intersection observer for smooth animation
...
// (Removed enforceQualityProductsBreak: no longer forcing line breaks)
...
function startAutoCarousel(carouselContainer) {
    ...
    function nextSlide() {
        ...
        console.log('Moving to slide:', currentSlideIndex, 'of', slides.length);
    ...
    function startInterval() {
        ...
        console.log('Auto-carousel started for:', carouselContainer);
    }
    ...
    addSwipeSupport(carouselContainer, nextSlide, prevSlide);
    
    // Add navigation arrows
    addNavigationArrows(carouselContainer, nextSlide, prevSlide);
    
}

// Add swipe support to carousel
function addSwipeSupport(container, nextSlide, prevSlide) {
    let startX = 0;
    let startY = 0;
...
// Add navigation arrows to carousel
function addNavigationArrows(container, nextSlide, prevSlide) {
    // Create left arrow
...
const brandData = {
    ...
    'freud': {
        ...
        products: ['Saw Blades', 'Router Bits', 'Cutterheads', 'Industrial Knives', 'CNC Tools', 'Diamond Tools'],
        productsAr: ['شفرات المنشار', 'بتات الراوتر', 'رؤوس القطع', 'سكاكين صناعية', 'أدوات CNC', 'أدوات قطع الماس']
    },
    'kleiberit': {
        name: 'Kleiberit',
        country: 'Germany',
    ...
    'leuco': {
        ...
        productsAr: ['شفرات المنشار', 'بتات الراوتر', 'رؤوس القطع', 'أدوات قطع الماس', 'أدوات الحفر']
    },
    'leitz': {
        name: 'Leitz',
    ...
    'gda': {
        ...
        productsAr: ['شفرات المنشار', 'رؤوس القطع', 'بتات الراوتر', 'أدوات قطع الماس']
    },
    'twt': {
        name: 'TWT',
        country: 'Italy',
    ...
    'wemaro': {
        ...
        products: ['Router Bits', 'Drill Bits', 'End Mills', 'Countersinks', 'Saw Blades'],
        productsAr: ['بتات الراوتر', 'بتات الحفر', 'مطاحن النهاية', 'مثقاب التوسيع', 'شفرات المنشار']
    },
    'bsp': {
        name: 'BSP',
        country: 'Italy',
    ...
    'ilma': {
        ...
        products: ['Cutterheads', 'Planer Knives', 'Corrugated Knives'],
        productsAr: ['رؤوس القطع', 'سكاكين الفارة', 'سكاكين مموّجة']
    },
    'carl-rontigen': {
        name: 'Carl Rontgen',
        country: 'Germany',
        ...
        products: ['Band Saw Blades', 'Frame Saw Blades'],
        productsAr: ['شفرات منشار الشريط', 'شفرات منشار الإطار']
    },
    'interabrasive': {
        name: 'Inter Abrasive',
        country: 'Turkey',
    ...
    'utensil-centro': {
        ...
        productsAr: ['رؤوس القطع', 'بتات الراوتر', 'شفرات المنشار', 'أدوات قطع الماس']
    },
    'said-tools': {
        name: 'Said Tools',
        country: 'Italy',
        description: 'Manufacturer of Diamond Wheels for Sharpening.',
        descriptionAr: 'مصنّع عجلات ألماس لعمليات السن.',
        products: ['Diamond Wheels'],
        productsAr: ['عجلات ألماس']
    }
};
...
function openBrandPopup(brandId) {
    ...
    let countryText = brand.country;
    if (isArabic) {
        // Map English country names to Arabic translation keys
        const countryMap = {
            'Germany': 'brands.countries.germany',
            'Italy': 'brands.countries.italy',
            'USA': 'brands.countries.usa',
            'China': 'brands.countries.china',
            'Turkey': 'brands.countries.turkey',
            'Korea': 'brands.countries.korea',
            'Germany / Austria': 'brands.countries.germany_austria'
        };
        const translationKey = countryMap[brand.country];
        if (translationKey && translations.ar[translationKey]) {
            countryText = translations.ar[translationKey];
        }
    }
    brandCountry.textContent = countryText;
